...
class PrintPCodeCapability : public PrintLanguageCapability {
    static PrintPCodeCapability printPCodeCapability;			///< The singleton instance
    PrintPCodeCapability(void);					///< Initialize the singleton
    PrintPCodeCapability(const PrintPCodeCapability &op2);		///< Not implemented
    PrintPCodeCapability &operator=(const PrintPCodeCapability &op);	///< Not implemented
public:
...
struct PartialSymbolEntryPCode {
...
///  - loop structures
///  - etc.
class PrintPCode : public PrintLanguage {
protected:
    ...
    void resetDefaultsPrintPCode(void);			///< Set default values for options specific to PrintPCode
...
public:
    PrintPCode(Architecture *g,const string &nm="c-language");	///< Constructor
    ...
    string getPcodeOpName(int opcode);
